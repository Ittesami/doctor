...
export default function AppointmentPage() {
  ...
  const t = {
    en: {
      ...
      chamberName: "Specialized Colorectal Center",
      chamberAddress: "Rupayan Khan Plaza, Lift 8, House 18, Dhanmondi 7, Mirpur road, Dhaka",
    ...
    bn: {
      ...
      chamberAddress: "রূপায়ন খান প্লাজা, লিফট 8, হাউস 18, ধানমন্ডি 7, মিরপুর রোড, ঢাকা",
