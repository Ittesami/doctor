...
export default function Footer() {
  ...
  const t = {
    en: {
      ...
      contact: "Contact",
      chamber1Name: "Specialized Colorectal Center",
      address: "Rupayan Khan Plaza, Lift 8, House 18, Dhanmondi 7, Mirpur road, Dhaka",
    ...
    bn: {
      ...
      address: "রূপায়ন খান প্লাজা, লিফট 8, হাউস 18, ধানমন্ডি 7, মিরপুর রোড, ঢাকা",
